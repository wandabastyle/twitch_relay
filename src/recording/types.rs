...
/// Context for NFO-related operations passed to recording functions.
#[derive(Debug, Clone, Copy)]
pub(super) struct NfoContext<'a> {
   pub(super) write_nfo: bool,
   pub(super) nfo_style: crate::config::RecordingNfoStyle,
   pub(super) twitch:    &'a crate::twitch_auth::TwitchAuthService,
}
