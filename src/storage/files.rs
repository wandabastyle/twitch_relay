...
/// Loads and deserializes JSON from a file, returning `None` if the file
/// doesn't exist.
///
...
/// Loads and deserializes TOML from a file, returning `None` if the file
/// doesn't exist.
///
...
/// as the target path with ".tmp" appended (e.g., "file.json" ->
/// "file.json.tmp").
