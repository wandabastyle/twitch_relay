...
export function clearPreview(options: ClearPreviewOptions): void {
...
export function startPreviewTimer(options: StartPreviewTimerOptions): void {
  const {
    rect,
    imageUrl,
    previewDelayMs,
...
export function endPreview(options: EndPreviewOptions): void {
